...
public class TrackingReceiver : MonoBehaviour
{
    ...
    void StartPose() {
        ...
        //pose.Add("righElbow", Vector3.zero);
    ...
    void Update()
    {
        ...
        //ElbowR.transform.position = pose["righElbow"];
        //ElbowL.transform.position = pose["leftElbow"];
        //HipR.transform.position = pose["righHip"];
        //HipL.transform.position = pose["leftHip"];
        //kneeR.transform.position = pose["rightKnee"];
        //kneeL.transform.position = pose["leftKnee"];
